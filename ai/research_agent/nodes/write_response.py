...
def write_response(state: ResearchAgentState, spinner_controller: SpinnerController = None):
    ...
    system_msg = SystemMessage(content=(
        ...
        "- Define complex terms as needed.\n"
        "- SEP articles often have weird spacing and characters. Use whatever feels best in your quotes and citations (there "
        "are random line breaks, missing whitespaces, and invisible/weird chars).\n\n"

        "## YOUR CAPABILITIES (for reference when offering further help or asked about what you can do):\n"
        "- Semantically search Project Gutenberg sources\n"
        ...
        "the database (as it will indicate in the above resources) and it's relevant to your response, say that you don't "
        "have access to it and say you will try your best to answer the question given the resources you DO have access to.\n\n"
